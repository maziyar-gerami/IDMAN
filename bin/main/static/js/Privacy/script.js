        ...
        methods: {
            changeLang: function () {
                if (this.lang == "EN") {
                    ...
                    this.s23 = "Parsso makes every effort to ensure the security of users' personal information and uses this information for better service and timely and appropriate response, the text of which is described below.",
                    this.s24 = "Parsso receives information from the user, part of which is provided by the user, and part is automatically received by the user's system, which of course does not include personal information and user privacy.",
                    ...
                    this.s40 = "After logging in to Parsso, users can access the services connected to it, these services are not under Parsso's supervision and Parsso is not responsible for them. You should note that the personal information you send to the services will not be monitored by the Privacy Policy, and we recommend that you be aware of the their Privacy Policy and security policies.",
                    this.s41 = "Cookies",
                    this.s42 = "When visiting a website, information may be stored on your computer through cookies that allow you to automatically identify your computer on your next visit to the website. The cookie itself does not contain personal information. But at the same time, it enables us to link your use of this website to information that is specifically and consciously provided.The only personal information a cookie can contain is the information you provide. The cookie cannot read the data on the hard disk or cookie files created by other websites. You can set your browser to reject all cookies or send cookies. If you do not accept cookies, it may not be possible to use certain sections of this website.",
                    ...
                    this.s45 = "We use security measures to protect your information from the access of unauthorized persons, you have the right to be aware of your stored information and ask us to make changes to it to be accurate and up to date. Let us know if you are interested.",
