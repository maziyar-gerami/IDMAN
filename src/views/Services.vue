        ...
        if (res.data.status.code === 200) {
          ...
          vm.axios({
            ...
            if (res1.data.status.code === 200) {
              ...
              console.log(vm.allowedGroupsReportList)
              console.log(vm.bannedGroupsReportList)
              vm.axios({
                url: "/api/users",
                method: "GET"
              }).then((res2) => {
                if (res2.data.status.code === 200) {
                  vm.usersReportList = res2.data.data
                  n = 1
                  m = 1
                  ...
                  console.log(vm.allowedUsersReportList)
                  console.log(vm.bannedUsersReportList)
                  if (format === "pdf") {
                    const doc = new JSPDF()
