document.addEventListener('DOMContentLoaded', function () {
    ...
    new Vue({
        ...
        data: {
            ...
            s51: "زمان انقضا رمز عبور",
            s52: "ایمیل بازیابی رمز عبور با موفقیت ارسال شد.",
            s53: "حذف کاربر",
            s54: "اعمال",
            s55: "آیا از حذف کاربران انتخاب شده اطمینان دارید؟",
            s56: "هیچ کاربری انتخاب نشده است.",
            s57: "بازیابی رمزعبور همه",
            s58: "جدید",
            s59: "بازیابی رمز عبور",
            s60: "فایل نمونه",
            s61: "نام فارسی",
            s62: "گروه",
            s63: "وضعیت",
            ...
            accessReport: "گزارش های دسترسی کاربر",
            searchText: "جستجو...",
        ...
        methods: {
                ...
                axios.get(url + "/api/users/u/" + id) //
                    .then((res) => {
                        ...
                        if(typeof res.data.services !== "undefined"){
                            if(typeof res.data.services.licensed !== "undefined"){
                                for(let i = 0; i < res.data.services.licensed.length; ++i){
                                    res.data.services.licensed[i].recordNumber = i + 1;
                                }
                                vm.allowedServicesReportList = res.data.services.licensed;
                            }
                            if(typeof res.data.services.unLicensed !== "undefined"){
                                for(let i = 0; i < res.data.services.unLicensed.length; ++i){
                                    res.data.services.unLicensed[i].recordNumber = i + 1;
                                }
                                vm.bannedServicesReportList = res.data.services.unLicensed;
                            }
                        }
            ...
            exportReports: function (format) {
                if(format === "pdf"){
                    ...
                    doc.autoTable({
                        startY: 20,
                        body: [[this.U2, this.reportedUser.userId],
                            [this.U5, this.reportedUser.displayName],
                            [this.U6, this.reportedUser.mobile],
                            [this.U7, this.reportedUser.mail]],
                        styles: {
                            font: "IRANSansWeb",
                        },
                    });
                    ...
                    doc.text(this.allowedServicesText, 10, finalY + 10);
                    doc.autoTable({
                        startY: finalY + 20,
                        head: [["#", this.idText, this.nameText]],
                        body: tempArray,
                        styles: {
                            font: "IRANSansWeb",
                        },
                    ...
                    finalY = doc.lastAutoTable.finalY;
                    doc.text(this.bannedServicesText, 10, finalY + 10);
                    doc.autoTable({
                        startY: finalY + 20,
                        head: [["#", this.idText, this.nameText]],
                        body: tempArray,
                    ...
                    doc.save("Parsso-UserReport-" + this.reportedUser.userId + ".pdf");
                }else if(format === "xlsx"){
                    let fileName = "Parsso-UserReport-" + this.reportedUser.userId;
                    let fileData = [[this.U2,this.reportedUser.userId,"",this.U5,this.reportedUser.displayName,"",this.U6,this.reportedUser.mobile,"",this.U7,this.reportedUser.mail],
                        [""],
            ...
            changeLang: function () {
                if(this.lang == "EN"){
                    ...
                    this.accessReport = "User Access Reports";
                    ...
                    this.s51 = "زمان انقضا رمز عبور";
                    this.s52 = "ایمیل بازیابی رمز عبور با موفقیت ارسال شد.";
                    this.s53 = "حذف کاربر";
                    this.s54 = "اعمال";
                    this.s55 = "آیا از حذف کاربران انتخاب شده اطمینان دارید؟";
                    this.s56 = "هیچ کاربری انتخاب نشده است.";
                    this.s57 = "بازیابی رمزعبور همه";
                    this.s58 = "جدید";
                    this.s59 = "بازیابی رمز عبور";
                    this.s60 = "فایل نمونه";
                    this.s61 = "نام فارسی";
                    this.s62 = "گروه";
                    this.s63 = "وضعیت";
                    ...
                    this.accessReport = "گزارش های دسترسی کاربر";
