    ...
    new Vue({
      ...
      methods: {
        ...
        showReport: function (id) {
          ...
          axios.get(url + "/api/services/" + id) //
            .then((res) => {
              vm.reportedService = res.data;
              vm.getUsersList();
              vm.getGroups();

              for(let i = 0; i < vm.userSearch.length; ++i){
                if(typeof res.data.accessStrategy.requiredAttributes.uid !== "undefined"){
                  if(res.data.accessStrategy.requiredAttributes.uid[1].includes(vm.userSearch[i].userId)){
                ...
                if(typeof res.data.accessStrategy.rejectedAttributes !== "undefined"){
                  if(typeof res.data.accessStrategy.rejectedAttributes.uid !== "undefined"){
                    if(res.data.accessStrategy.rejectedAttributes.uid[1].includes(vm.userSearch[i].userId)){
              ...
              for(let i = 0; i < vm.groups.length; ++i){
                if(typeof res.data.accessStrategy.requiredAttributes.ou !== "undefined") {
                  if (res.data.accessStrategy.requiredAttributes.ou[1].includes(vm.groups[i].id)) {
        ...
        exportReports: function (format) {
          ...
          if(format === "pdf"){
            ...
            doc.autoTable({
              startY: 20,
              body: [[this.s20, this.reportedService.id],
              [this.s28, this.reportedService.name],
              [this.s30, this.reportedService.serviceId],
              [this.s31, this.reportedService.description]],
              styles: {
                font: "IRANSansWeb"
              },
            });
            ...
            doc.text(this.s76, 10, finalY + 10);
            doc.autoTable({
              startY: finalY + 20,
              head: [["#", this.s20, this.displayNameFaText]],
              body: tempArray,
              styles: {
                font: "IRANSansWeb"
              },
            ...
            finalY = doc.lastAutoTable.finalY;
            doc.text(this.s79, 10, finalY + 10);
            doc.autoTable({
              startY: finalY + 20,
              head: [["#", this.s20, this.displayNameFaText]],
              body: tempArray,
            ...
            finalY = doc.lastAutoTable.finalY;
            doc.text(this.allowedGroupsText, 10, finalY + 10);
            doc.autoTable({
              startY: finalY + 20,
              head: [["#", this.enNameText, this.faNameText]],
              body: tempArray,
              styles: {
                font: "IRANSansWeb"
              },
            ...
            finalY = doc.lastAutoTable.finalY;
            doc.text(this.bannedGroupsText, 10, finalY + 10);
            doc.autoTable({
              startY: finalY + 20,
              head: [["#", this.enNameText, this.faNameText]],
              body: tempArray,
            ...
            let fileData = [[this.s20,this.reportedService.id,"",this.s28,this.reportedService.name,"",this.s30,this.reportedService.serviceId,"",this.s31,this.reportedService.description],
              ...
              ["#",this.s20,this.displayNameFaText,"","#",this.s20,this.displayNameFaText,"","#",this.enNameText,this.faNameText,"","#",this.enNameText,this.faNameText]];
            let maxLength = Math.max(this.allowedUsersReportList.length, this.bannedUsersReportList.length, this.allowedGroupsReportList.length, this.bannedGroupsReportList.length)
            ...
            let tempArray3 = new Array(maxLength - this.allowedGroupsReportList.length).fill({"recordNumber":"", "id":"", "name":""});
            let tempArray4 = new Array(maxLength - this.bannedGroupsReportList.length).fill({"recordNumber":"", "id":"", "name":""});
            tempArray1 = this.allowedUsersReportList.concat(tempArray1);
            tempArray2 = this.bannedUsersReportList.concat(tempArray2);
            tempArray3 = this.allowedGroupsReportList.concat(tempArray3);
            tempArray4 = this.bannedGroupsReportList.concat(tempArray4);
            for(let i = 0; i < maxLength; ++i){
              fileData.push([tempArray1[i].recordNumber, tempArray1[i].userId, tempArray1[i].displayName, "",
                ...
                tempArray3[i].recordNumber, tempArray3[i].id, tempArray3[i].name, "",
                tempArray4[i].recordNumber, tempArray4[i].id, tempArray4[i].name]);
            }
