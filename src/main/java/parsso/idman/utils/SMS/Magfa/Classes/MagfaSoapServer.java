...
public interface MagfaSoapServer {
     ...
     * @param shortNumber
     * @param count
     * @return returns com.company.MessagesResult
     */
    @WebMethod
     ...
     *
     * @param uid
     * @return returns com.company.MessageIdResult
     */
    @WebMethod
    @WebResult(partName = "return")
    MessageIdResult mid(
     ...
     *
     * @param mids
     * @return returns com.company.DeliveryResult
     */
    @WebMethod
    @WebResult(partName = "return")
     ...
     * @param udhs
     * @param senders
     * @return returns com.company.SendResult
     */
    @WebMethod
    @WebResult(partName = "return")
    SendResult send(
     ...
     * Get account balance
     *
     * @return returns com.company.CreditResult
     */
    @WebMethod
    @WebResult(partName = "return")
