package parsso.idman.utils.crypto;
...
public interface CipherExecutor<I, O> {
   ...
   */
  String DEFAULT_CONTENT_ENCRYPTION_ALGORITHM = ContentEncryptionAlgorithmIdentifiers.AES_128_CBC_HMAC_SHA_256;
   ...
   * Factory method.
   *
   * @return Strongly -typed Noop
   *         {@code CipherExecutor Serializable -> Serializable}
   */
