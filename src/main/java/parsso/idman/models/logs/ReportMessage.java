...
public class ReportMessage {
  ...
  public ReportMessage(String model, Object instance, String attribute, String action, String result,
      String description) {
    this.model = model;
  ...
  public ReportMessage(String model, Object instance, String attribute, String action, String result, Object to,
      String description) {
    this.model = model;
    this.instance = instance;
    this.attribute = attribute;
  ...
  public ReportMessage(String model, Object instance, String attribute, String action, String result, String type,
  ...
  public ReportMessage(String model, Object instance, String attribute, String action, String result, Object from,
      Object to, String description) {
    this.model = model;
    this.instance = instance;
    this.attribute = attribute;
    this.result = result;
  ...
  public String toString() {
    ...
    last = last.replaceAll(String.valueOf(separator) + separator + separator + separator,
  ...
  */
  ...
  private List<Change> difference(Object o1, Object o2) {
    ...
    List<org.javers.core.diff.changetype.ValueChange> changes = diff
        .getChangesByType(org.javers.core.diff.changetype.ValueChange.class);
