...
public class BackupSettings {
  ...
  public HttpStatus backup(String doerID) {
    ...
    try {
      ...
      uniformLogger.info(doerID, new ReportMessage(Variables.MODEL_SETTINGS, String.valueOf(_id),
          Variables.ACTION_BACKUP, Variables.RESULT_SUCCESS));
      return HttpStatus.OK;
    } catch (Exception e) {
      uniformLogger.info(doerID, new ReportMessage(Variables.MODEL_SETTINGS, String.valueOf(_id),
          Variables.ACTION_BACKUP, Variables.RESULT_FAILED));
      e.printStackTrace();
