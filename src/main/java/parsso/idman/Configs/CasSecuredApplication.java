...
public class CasSecuredApplication {
    ...
    @Value(value = "${cas.url.login.path}")
    private String casUrlLoginPath;

    @Value(value = "${cas.url.logout.path}")
    private String cadUrlLogoutPath;
    ...
    public ServiceProperties serviceProperties() {
        ...
        serviceProperties.setService(casUrlLoginPath);
    ...
    public LogoutFilter logoutFilter() {
        LogoutFilter logoutFilter = new LogoutFilter(cadUrlLogoutPath,
