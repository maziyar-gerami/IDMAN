...
public class Supplementary extends UsersOps {
    ...
    public ResponseEntity<Response> sendMessageUser(
        ...
        if (user == null)
            return new ResponseEntity<>(new Response(null, Variables.MODEL_USER , HttpStatus.NOT_FOUND.value() ,lang),HttpStatus.OK);
        ...
        if (time > 0) {
            ...
            return new ResponseEntity<>(new Response(null, Variables.MODEL_USER , HttpStatus.EXPECTATION_FAILED.value(),lang),HttpStatus.OK);
    ...
    public ResponseEntity<Response> resetPassMessage(@PathVariable("uId") String uId,
        ...
        return new ResponseEntity<>(new Response(null,Variables.MODEL_CAPTCHA,(result==HttpStatus.OK) ?HttpStatus.OK.value():HttpStatus.BAD_REQUEST.value(),lang),HttpStatus.OK);
    }
    ...
    public Object resetPass(@PathVariable("uId") String uId, @PathVariable("token") String token,
            RedirectAttributes attributes,@RequestParam(value="lang", defaultValue= "fa") String lang) throws NoSuchFieldException, IllegalAccessException{
        ...
        return new ResponseEntity<>(new Response(null, Variables.MODEL_USER , HttpStatus.BAD_REQUEST.value(),lang),HttpStatus.OK);
    }
