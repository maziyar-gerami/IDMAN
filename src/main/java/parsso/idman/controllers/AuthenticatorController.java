...
public class AuthenticatorController {
    ...
    public AuthenticatorController(AuthenticatorRepo.Retrieve authenticatorRepoRetrieve, AuthenticatorRepo.Delete authenticatorRepoDelete) {
    ...
    public ResponseEntity<Response> deleteBuUsername(HttpServletRequest request, @RequestParam(value = "username", defaultValue = "") String username,
        ...
        if (username.equals("") && deviceName.equals(""))
            ...
            return new ResponseEntity<>(new Response(null, Variables.MODEL_AUTHENTICATOR, authenticatorRepoDelete
