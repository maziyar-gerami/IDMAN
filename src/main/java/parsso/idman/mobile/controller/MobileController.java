...
public class MobileController {
  ...
  public @ResponseBody ResponseEntity<String> mobileNumber(@RequestParam("uid") String uid,
  ...
  public @ResponseBody ResponseEntity<HttpStatus> sendSMS(@RequestParam("uid") String uid,
      @RequestParam("qrToken") String QrToken) {
    User user = usersOpRetrieve.retrieveUsers(uid);
  ...
  public @ResponseBody ResponseEntity<JSONObject> active(@RequestParam("uid") String uid,
      @RequestParam("smsCode") String smsCode, @RequestParam("qrToken") String QrToken) {
    User user = usersOpRetrieve.retrieveUsers(uid);
  ...
  public @ResponseBody ResponseEntity<List<MicroService>> M_listServices(
  ...
  public @ResponseBody ResponseEntity<User> M_retrieveUser(@RequestParam("mobileToken") String MobileToken,
      @RequestParam("uid") String uid) {
    User user = usersOpRetrieve.retrieveUsers(uid);
    if (MobileToken.equals(user.getUsersExtraInfo().getMobileToken()))
  ...
  public @ResponseBody ResponseEntity<byte[]> M_retrieveUserPhoto(@RequestParam("mobileToken") String MobileToken,
      @RequestParam("uid") String uid) {
    User user = usersOpRetrieve.retrieveUsers(uid);
    if (MobileToken.equals(user.getUsersExtraInfo().getMobileToken()))
