package parsso.idman.repoImpls.tickets;
...
import parsso.idman.repoImpls.tickets.subclass.CreateTickets;
import parsso.idman.repoImpls.tickets.subclass.DeleteTickets;
import parsso.idman.repoImpls.tickets.subclass.RetrieveTickets;
import parsso.idman.repoImpls.tickets.subclass.UpdateTickets;
...
public class TicketRepoImpl implements TicketRepo {
    ...
    @Autowired
    public TicketRepoImpl(MongoTemplate mongoTemplate,UniformLogger uniformLogger, UserRepo.UsersOp.Retrieve userOpRetrieve){
    ...
    public ListTickets retrieve(String doer, String cat, String subCat, String status, String page, String count, String from, String ticketId, String date) {
        ...
        return new RetrieveTickets(mongoTemplate).retrieve(doer, cat, subCat, status, page, count, from, ticketId, date);
    }
