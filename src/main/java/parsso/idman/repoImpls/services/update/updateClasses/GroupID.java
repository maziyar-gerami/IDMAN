package parsso.idman.repoImpls.services.update.updateClasses;
...
public class GroupID {
    ...
    public void change(String doerID, Service service, long sid, String name, String oldOu, String newOu) throws IOException {
        ...
        try {
            FileWriter file = new FileWriter(new Settings(mongoTemplate).retrieve(Variables.SERVICE_FOLDER_PATH).getValue() + filePath, false);
