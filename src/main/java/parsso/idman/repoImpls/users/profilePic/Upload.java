...
public class Upload {
   ...
   final FilesStorageService storageService;
    ...
    public Upload(MongoTemplate mongoTemplate, UserRepo.UsersOp.Retrieve usersOpRetrieve,UserRepo.UsersOp.Update usersOpUpdate, FilesStorageService storageService) {
